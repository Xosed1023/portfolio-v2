      ...
      <div className="relative overflow-hidden" style={{ aspectRatio: "16/10", background: "rgba(0,0,0,0.5)" }}>
        ...
        <motion.div className="absolute inset-0 flex flex-col items-center justify-center gap-3"
          ...
          <a href="https://wa.me/573165782144" target="_blank" rel="noopener noreferrer"
             className="font-poppins font-semibold px-6 py-[9px] w-44 text-center btn-project"
             style={{ background: project.accent, color: "#0a0a0a", fontSize: "0.65rem", letterSpacing: "0.26em" }}>
            {wantThis}
          </a>
          {project.notion ? (
    ...
    <>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 flex items-center justify-between px-6 lg:px-10 py-4"
        ...
        <TransitionLink href={returnHref} className="flex items-center gap-2 group">
          <svg width="13" height="13" viewBox="0 0 14 14" fill="none" className="group-hover:text-accent transition-colors duration-200"
               style={{ color: "rgba(var(--rgb),0.35)" }}>
            <path d="M9 2L4 7L9 12" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
          <span className="font-poppins font-medium group-hover:text-accent transition-colors duration-200"
                style={{ fontSize: "0.72rem", letterSpacing: "0.22em", color: "rgba(var(--rgb),0.35)" }}>
          ...
          <div className="relative flex-1 flex flex-col justify-center max-w-[1680px] mx-auto w-full"
            ...
            <motion.div className="flex flex-wrap gap-4"
              ...
              <button onClick={() => document.getElementById("proyectos")?.scrollIntoView({ behavior: "smooth", block: "start" })}
                className="font-poppins font-semibold px-8 py-3 btn-cta"
        ...
        <section className="relative min-h-screen flex flex-col items-center justify-center"
          ...
          <div className="relative text-center w-full max-w-[1680px] mx-auto" style={{ paddingLeft: PX, paddingRight: PX, paddingTop: "clamp(4rem,8vh,6rem)", paddingBottom: "clamp(4rem,8vh,6rem)" }}>
            ...
            <motion.div className="flex flex-wrap items-center justify-center gap-4"
              ...
              <a href="https://wa.me/573165782144" target="_blank" rel="noopener noreferrer"
                 className="font-poppins font-semibold px-10 py-[14px] flex items-center gap-2 btn-cta"
                 style={{ fontSize: "0.75rem", letterSpacing: "0.3em" }}>
          ...
          <div className="hidden lg:flex absolute bottom-0 left-0 right-0 items-center justify-between"
            ...
            <TransitionLink href={returnHref}
                  ...
                  style={{ fontSize: "0.68rem", letterSpacing: "0.2em", color: "rgba(var(--rgb),0.28)" }}>
