...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* ── PORTRAIT (LEFT) — desktop only ── */}
      <motion.div
        className="absolute top-0 bottom-0 hidden lg:block"
        style={{ left: "72px", width: "clamp(260px, 50%, 680px)" }}
      ...
      >
        ...
        {/* Dark overlay — encima de la foto (z-index 2), baja opacidad en hover */}
        <div
          className="absolute inset-0 pointer-events-none"
          style={{
            zIndex: 2,
            background: "rgba(10,10,10,0.5)",
            opacity: portraitHovered ? 0.42 : 0.86,
        ...
        <div
          ...
          style={{
            zIndex: 3,
            background: "radial-gradient(ellipse 60% 70% at 55% 35%, rgba(201,169,110,0.07) 0%, transparent 70%)",
          }}
        />

        {/* Edge fades */}
        <div className="absolute top-0 left-0 bottom-0 w-24 bg-gradient-to-r from-[#0a0a0a] to-transparent" style={{ zIndex: 3 }} />
        <div className="absolute top-0 right-0 bottom-0 w-44 bg-gradient-to-l from-[#0a0a0a]/75 to-transparent" style={{ zIndex: 3 }} />
      ...
      {/* ── INFO PANEL — desktop (right side absolute) ── */}
      <motion.div
        className="absolute top-0 right-0 bottom-0 flex-col justify-center hidden lg:flex"
        style={{
          width: "clamp(360px, 54%, 700px)",
          paddingRight: "clamp(3rem, 6vw, 5.5rem)",
          paddingLeft: "clamp(1.5rem, 2.5vw, 3rem)",
      ...
      >
        ...
        {/* Bio — from CV */}
        <motion.p
          className="font-nunito font-light leading-[1.9] mb-4 max-w-[420px]"
        ...
        <motion.div className="flex items-center gap-3 mt-5 mb-1" {...fadeUp(1.5)}>
          ...
          <a
            ...
            style={{ fontSize: "0.65rem", letterSpacing: "0.3em", border: "1px solid rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.6)" }}
          >
            CONTACTAR
          </a>
        </motion.div>
      ...
      <div className="lg:hidden absolute inset-0 flex flex-col justify-center items-center text-center px-6 pt-16"
        ...
        />
        <motion.p
          className="font-nunito font-light leading-[1.85] mb-4 max-w-[340px]"
        ...
        <motion.div className="flex flex-wrap gap-[6px] mb-4 justify-center" {...fadeUp(1.05)}>
          {SKILLS.map((tag) => (
            <span
              ...
              style={{ fontSize: "0.62rem", letterSpacing: "0.25em", padding: "3px 9px", color: "rgba(255,255,255,0.60)" }}
            >
              {tag}
            </span>
          ))}
        ...
        <motion.div className="flex items-center gap-3 mt-4 mb-1" {...fadeUp(1.5)}>
          ...
          <a
            ...
            style={{ fontSize: "0.63rem", letterSpacing: "0.28em", border: "1px solid rgba(255,255,255,0.15)", color: "rgba(255,255,255,0.6)" }}
          >
            CONTACTAR
          </a>
        </motion.div>
      ...
      <motion.div
        ...
        style={{
          left: "calc(72px + clamp(260px, 50%, 680px) / 2)",
      ...
      {/* Copyright */}
      <motion.p
        className="absolute bottom-8 right-10 font-poppins hidden md:block"
      ...
      <motion.div
        className="absolute top-8 right-10 font-poppins hidden md:block"
